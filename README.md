...
\- Retro\* (Retro Star) — implementation of Retro\*: Learning Retrosynthetic Planning with Neural Guided A\* Search: \[binghong-ml/retro\_star](https://github.com/binghong-ml/retro\_star)  
...
\- SA score (Ertl \& Schuffenhauer, 2009) — common implementation available in RDKit: \[rdkit/Contrib/SA\_Score/sascorer.py](https://github.com/rdkit/rdkit/blob/master/Contrib/SA\_Score/sascorer.py)
